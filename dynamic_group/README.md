...
| <a name="input_matching_rule"></a> [matching\_rule](#input\_matching\_rule) | The matching rule to dynamically match an instance certificate to this dynamic group. | `string` | n/a | yes |
...
| Name | Description |
|------|-------------|
| <a name="output_id"></a> [id](#output\_id) | The OCID of the dynamic group |
